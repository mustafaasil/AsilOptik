...
namespace ApplicationCore.Services
{
    public class BasketService : IBasketServices
    {
        ...
        {
            var basket = await GetOrCreatBasketAsync(buyerId);
        ...
        public async Task<Basket> GetOrCreatBasketAsync(string buyerId)
        {
        ...
        public async Task TransferBasketAsync(string sourceBuyerId, string destinationBuyerId)
        {
            ...
            var destinationBasket = await GetOrCreatBasketAsync(destinationBuyerId);
